...
Route.get("/reset/:id/:password","AuthenticatorController.reset").middleware(["auth"]);
...
/* account */
Route.post("/account/edit", "AccountController.update").middleware(["auth"]);
Route.get("/myaccount", "AccountController.edit").middleware(["auth"]);
...
/* admin */
Route.get("/index", "DashboardController.index").middleware(["auth"]);
Route.get("/calendar", "CalendarController.index").middleware(["auth"]);
Route.post("/edit_canvan", "DashboardController.edit").middleware(["auth"]);
Route.get("/move_canvan", "DashboardController.move").middleware(["auth"]);
Route.get("/add_canvan", "DashboardController.add").middleware(["auth"]);
  /* staff */
  Route.group(() => {
...
Route.group(() => {
    ...
    Route.get(":project_id/validate", "ProjectController.validate").as("project_validate").middleware(["auth"]);
    Route.post(":project_id/finish", "ProjectController.finish").as("project_finish").middleware(["auth"]);
...
/* my project */
Route.get("/myprojects", "ProjectController.myIndex").middleware(["auth"]);

/* tasks */
Route.get("/task", "TaskController.index2").middleware(["auth"]);
Route.post("task/search", "TaskController.search").middleware(["auth"]);
Route.get("/task/:task_id/details", "TaskController.details").as("task_details").middleware(["auth"]);
Route.get("/task/:task_id/validate", "TaskController.validate").as("task_validate").middleware(["auth"]);
Route.post("/task/:task_id/finish", "TaskController.finish").as("task_finish").middleware(["auth"]);
Route.get("/task/add", "TaskController.create2").middleware(["auth"]);
Route.post("/task/store", "TaskController.store2").middleware(["auth"]);
Route.get("/task/:task_id/errors", "ErrorController.index2").as("error_list").middleware(["auth"]);
Route.get("/task/delete/:id", "TaskController.delete").as("delete_task").middleware(["auth"]);
Route.get("/task/:task_id/edit", "TaskController.edit").as("task_edit").middleware(["auth"]);
Route.post("/task/:task_id/update", "TaskController.update").as("task_update").middleware(["auth"]);
/* errors */
Route.group(() => {
...
}).prefix("/error").middleware(["auth"]);
/* teams */
Route.get("/team", "TeamController.index").middleware(["auth"]);
Route.get("/myteam", "TeamController.myteam").middleware(["auth"]);
Route.get("/add_team", "TeamController.create").middleware(["auth"]);
Route.post("/add_team", "TeamController.store").middleware(["auth"]);
Route.get("/team/delete/:id", "TeamController.delete").middleware(["auth"]);
Route.get("/team/:team_id/update", "TeamController.edit").as("team_edit").middleware(["auth"]);
Route.post("/team/:team_id/update", "TeamController.update").as("team_update").middleware(["auth"]);

/* technologies */
Route.get("/technology", "TechnologyController.index").middleware(["auth"]);
Route.get("/add_technology", "TechnologyController.create").middleware(["auth"]);
Route.post("/add_technology", "TechnologyController.store").middleware(["auth"]);
Route.get("/technology/:technology_id/update", "TechnologyController.edit").as("technology_edit").middleware(["auth"]);
Route.post("/technology/:technology_id/update", "TechnologyController.update").as("technology_update").middleware(["auth"]);
Route.get("/technology/delete/:id", "TechnologyController.delete").middleware(["auth"]);
Route.get("/technology/:tech_id/projects", "ProjectController.index").as("technology_project").middleware(["auth"]);
